...
const MobileFilter = ({ page, onFilter, onSort }) => {
  ...
  return (
    <div className="filter-bar">
      <div
        className="happening-now cursor-pointer flex justify-center w-fit sm:m-auto items-center h-10 py-1 text-sm font-medium hover:text-gray-500"
        onClick={() => {
